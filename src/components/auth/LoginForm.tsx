...
export function LoginForm() {
  ...
  const inputStyle = { backgroundColor: "#0f1929", border: "1px solid #2d3f55", color: "#e2e8f0" };
    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div className="space-y-1.5">
        <div className="flex items-center justify-between">
          ...
          <a href={ROUTES.forgotPassword} className="text-xs" style={{ color: "#60a5fa" }}>Vergessen?</a>
        </div>
        <div className="relative">
          <div className="absolute left-3 top-1/2 -translate-y-1/2 pointer-events-none" style={{ color: "#475569" }}>
